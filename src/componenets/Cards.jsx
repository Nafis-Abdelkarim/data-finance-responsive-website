    ...
    return(
        <div className="w-full py-[10rem] px-4 bg-white">
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                <div className='w-[75%] m-auto shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 md:w-full'>
                ...
                <div className='w-[75%] m-auto shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300 md:w-full'>
                ...
                <div className='w-[75%] m-auto shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 md:w-full'>
                    ...
                    <h2 className='text-2xl font-bold text-center py-8'>Groupe Account</h2>
